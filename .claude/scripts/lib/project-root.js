 ...
 * workflow context hooks reach it through projectRoot() in
 * .claude/hooks/lib/workflow-state.js, which prefers CLAUDE_PROJECT_DIR when the
 * harness sets it and otherwise delegates here.
 *
