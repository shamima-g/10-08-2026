...
// =============================================================================
// OPEN-PAGE - cross-platform open file in default browser
// =============================================================================
// Replaces the former Windows-only `start "" "<path>"` group: the workflow now
// opens every generated page through node .claude/scripts/open-page.js, which
// rides the existing node-script allow pattern on all platforms.
console.log('\nopen-page command');

testCommand('node .claude/scripts/open-page.js "generated-docs/dashboard.html"', 'allow', 'open-page dashboard (relative path)');
testCommand('node .claude/scripts/open-page.js generated-docs/dashboard.html', 'allow', 'open-page dashboard (no quotes)');
testCommand('node .claude/scripts/open-page.js "generated-docs/epics/checkout/manual-tests.html"', 'allow', 'open-page nested epic page');
testCommand('node .claude/scripts/open-page.js "generated-docs/reports/build-report.html"', 'allow', 'open-page build report');
